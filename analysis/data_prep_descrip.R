...
sel_data <- read_csv(here::here("output", "data", "dataset_table.csv.gz")) %>%
  select(patient_id,age_treated, sex, age_treated_group, ethnicity_snome,ethnicity_snome_cat, if_old_covid_treat, had_first_covid_treat, first_covid_treat_interve,first_covid_treat_date, first_covid_treat_status,
  ...
  death_cause_covid, allcause_death_60d_6m,covid_death_60d_6m, allcause_death_under60d, allcause_death_under30d
