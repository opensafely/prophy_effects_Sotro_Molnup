...
cox_model0 <- coxph(Surv(surv12m_days, surv12m_event_num) ~ (drug), data = high_risk_surv_data1) %>% summary()

cat("#1summary(cox_model_strata(region_num))")
cox_model_region<- coxph(Surv(surv12m_days, surv12m_event_num) ~ (drug)+ strata(region_num), data = high_risk_surv_data1) %>% summary()


cat("#2summary(cox_model_strata(stp))")
cox_model_stp <- coxph(Surv(surv12m_days, surv12m_event_num) ~ (drug)+ strata(stp), data = high_risk_surv_data1) %>% summary()
...
+ strata(region_num), data = high_risk_surv_data1) %>% summary()
...
+ strata(stp), data = high_risk_surv_data1) %>% summary()
...
+ high_risk_num + strata(region_num), data = high_risk_surv_data1) %>% summary()
...
+ high_risk_num + strata(stp), data = high_risk_surv_data1) %>% summary()
...
+ high_risk_num + covid_vacc_num + strata(region_num), data = high_risk_surv_data1) %>% summary()
...
+ high_risk_num + covid_vacc_num + strata(stp), data = high_risk_surv_data1) %>% summary()
...
cox_model1_age_sex_highrisk_vacc_imd_reg_eth_region <- coxph(Surv(surv12m_days, surv12m_event_num) ~ drug + age_treated + sex_num 
    + high_risk_num + covid_vacc_num + imd_num + ethnicity_num + strata(region_num), data = high_risk_surv_data1) %>% summary()
...
cox_model1_age_sex_highrisk_vacc_imd_reg_eth_stp <- coxph(Surv(surv12m_days, surv12m_event_num) ~ drug + age_treated + sex_num 
    + high_risk_num + covid_vacc_num + imd_num + ethnicity_num + strata(stp), data = high_risk_surv_data1) %>% summary()
...
# + chronic_cardiac_disease + chronic_respiratory_disease + strata(region_num), data = high_risk_surv_data1) %>% summary()
