...
ploting<- function(modl, figname){fit<-cox.zph(modl)
    plot<-ggcoxzph(fit)
...
ploting(cox_model1_age_sex_region, "cox_model1_region")
ploting(cox_model1_age_sex_highrisk_region, "cox_model2_region")
ploting(cox_model1_age_sex_highrisk_vacc_imd_reg_eth_region, "cox_model3_region")
ploting(cox_model1_age_sex_highrisk_region, "cox_model4_region")
